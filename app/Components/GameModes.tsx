...
const gameModes = [
  {
    title: "Survival",
    description: "Experience the classic Minecraft challenge. Gather resources, build structures, and survive against mobs in a vast, ever-changing world.",
    image: survivalImage
  },
  {
    title: "Kit PVP",
    description: "La modalità Kit PVP è dove potrai scaricare tutta la tua rabbia su un nemico, rillassantissima se devi scaricarti dopo una lunga e difficile giornata!",
    image: screenshoot
  },
  {
    title: "Skyblock",
    description: "Start your journey on a floating island with minimal resources. Expand your territory and overcome unique challenges in the sky.",
    image: tomba
  }
]
  ...
  return (
    <div className="bg-gray-900 py-16 px-4 sm:px-6 lg:px-8" id='modalità'>
      <div className="max-w-7xl mx-auto">
        <h2 className="text-orange-500 text-lg mb-2" style={{ fontFamily: "MineCraftFont" }}>COSA OFFRIAMO</h2>
        <h3 className="text-white text-4xl font-bold mb-8" style={{ fontFamily: "MineCraftFont" }}>SCOPRI LE NOSTRE MODALITÀ</h3>
